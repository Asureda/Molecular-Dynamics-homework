MODULE read_data
    ...
    integer :: n_meas,n_meas_time_ev,n_melting,n_meas_gr
    logical :: is_print_thermo,is_time_evol,is_thermostat,is_compute_gr
    real*8  :: dx_radial
    ...
    integer :: M,n_radial
    real*8 :: L,a,t_a,t_eqa,kinetic,potential,pressure,px,py,pz
