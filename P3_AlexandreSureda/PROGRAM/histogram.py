...
ax.hist(vx_old,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_x$")
ax.hist(vy_old,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_y$")
ax.hist(vz_old,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_z$")
...
# Compute histogram of velocities using the last half of the trajectory
# Flatten is equired to transform a 2d array into a 1d array
ax.hist(vx_new,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_x$")
ax.hist(vy_new,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_y$")
ax.hist(vz_new,bins='auto',density=True,alpha=0.5,lw=0,label=r"$V_z$")
